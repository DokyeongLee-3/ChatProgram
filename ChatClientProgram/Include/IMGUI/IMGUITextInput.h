...
protected:
	...
	std::vector<std::function<void(char*)>>	m_vecInputCallback;
...
public:
	template <typename T>
	void AddCallback(T* Obj, void(T::* Func)(char*))
	{
		m_vecInputCallback.emplace_back(std::bind(Func, Obj, std::placeholders::_1));
	}
};
